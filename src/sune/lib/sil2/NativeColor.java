...
public final class NativeColor {
	...
	private static NativeColor INSTANCE;
	
	private final ImagePixelFormat<?> format;
	
	private NativeColor(ImagePixelFormat<?> format) {
		this.format = format;
	}
	
	public static final NativeColor get() {
		return INSTANCE == null ? INSTANCE = new NativeColor(ImagePixelFormats.getNativeFormat()) : INSTANCE;
	}
